...
void Window::Initialize()
{
	...
	//Create a LPCWSTR from a std::string
	std::wstring stemp = std::wstring(m_windowName.begin(), m_windowName.end());
	LPCWSTR windowName = stemp.c_str();
...
void Window::Shutdown()
{
	...
	UnregisterClass(L"Engine", m_hinstance);
	m_hinstance = NULL;
}
